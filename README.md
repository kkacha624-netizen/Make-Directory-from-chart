...
クラウドソーシング案件でよくある「指定されたディレクトリ構成を作る」「実験・納品用フォルダーを定型化する」といった作業を、手作業ではなく小さなツールとして自動化するために作成しました。
...
手作業でディレクトリを作るだけなら簡単ですが、何度も同じような構成を作る場合や、クライアントから提示された構成図を正確に再現する場合はミスが起きやすくなります。
